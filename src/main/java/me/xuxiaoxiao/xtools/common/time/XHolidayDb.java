...
class XHolidayDb {
    ...
    public static final Integer[] HOLIDAY_2021 = {0x3000, 0x1106, 0x210a, 0x310b, 0x310c, 0x310d, 0x210e, 0x210f, 0x2110, 0x1113, 0x3303, 0x2304, 0x1318, 0x3400, 0x2402, 0x2403, 0x2404, 0x1407, 0x350d, 0x1811, 0x2813, 0x3814, 0x1819, 0x3900, 0x3901, 0x3902, 0x2903, 0x2904, 0x2905, 0x2906, 0x1908};
